...
const Login = ({setToken}) => {
    ...
    const onSubmitHandler = async(e) =>{
        try {
            e.preventDefault() // prevent reload webpage after submitting
        ...
        <div className='bg-white shadow-md rounded-lg px-8 py-6 max-w-md'>
            ...
            <form onSubmit={onSubmitHandler} action="">
                <div className='mb-3 min-w-72'>
                    ...
                    <input onChange={(e)=>setEmail(e.target.value)} value={email} className='rounded-md w-full px-3 py-2 border border-gray-300' type="email" placeholder='Enter your email address' required/>
                </div>
                <div className='mb-3 min-w-72'>
